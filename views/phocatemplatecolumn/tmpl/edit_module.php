...
<form action="<?php JRoute::_('index.php?option=com_phocatemplate'); ?>" method="post" name="adminForm" id="phocatemplatecolumn-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<div class="ptwarning"><?php echo JText::_('COM_PHOCATEMPLATE_MODULE_MENU_LINKS_WARNING') ?></div>
		
		<ul class="adminformlist">
			<?php 
			$formArray = array ('title', 'width', 'ordering', 'moduleid');
...
<input type="hidden" name="jform[type]" id="jform_type" value="2" />
