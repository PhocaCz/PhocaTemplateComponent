...
class PhocaTemplateCpViewPhocaTemplateInfo extends JView
{
	public $tmpl;
	...
	protected function addToolbar() {
		JToolBarHelper::title( JText::_( 'COM_PHOCATEMPLATE_PT_INFO' ), 'info.png' );
		JToolBarHelper::cancel( 'cancel', 'COM_PHOCATEMPLATE_CLOSE' );
