...
class JFormFieldPhocaHead extends JFormField
{
	...
	protected function getLabel() {
		...
		// Temporary solution
		JHTML::stylesheet( 'administrator/components/com_phocatemplate/assets/phocatemplateoptions.css' );
		...
		if ($phocaImage != ''){
			$image 	= JHTML::_('image', 'administrator/components/com_phocatemplate/assets/images/'. $phocaImage, '' );
		}
