...
class JFormFieldModulePosition extends JFormFieldText
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('COM_PHOCATEMPLATE_CHANGE_POSITION_TITLE').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_PHOCATEMPLATE_CHANGE_POSITION_BUTTON').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
