...
class PhocaTemplateCpModelPhocaTemplateColumns extends JModelList
{
	...
	protected function populateState()
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_phocatemplate');
	...
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('filter.column_id');
	...
	protected function getListQuery()
	{
		...
		$query = ' SELECT a.*, cc.title AS guestbook, u.name AS editor '
			. ' FROM #__phocatemplate_items AS a '
			. ' LEFT JOIN #__phocatemplate_books AS cc ON cc.id = a.catid '
		...
		*/
		...
		$query->from('`#__phocatemplate_columns` AS a');
